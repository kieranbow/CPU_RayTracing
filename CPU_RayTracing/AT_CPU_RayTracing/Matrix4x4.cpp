...
Vector3 Matrix4x4::multiplyVectorToMatrix4x4(const Vector3& _lhs, Vector3& _rhs)
{
	...
	b = _lhs.getX() * m_elements.at(static_cast<int>(c::c10)) + _lhs.getY() * m_elements.at(static_cast<int>(c::c11)) + _lhs.getZ() * m_elements.at(static_cast<int>(c::c12)) + m_elements.at(static_cast<int>(c::c13));
	c = _lhs.getX() * m_elements.at(static_cast<int>(c::c20)) + _lhs.getY() * m_elements.at(static_cast<int>(c::c21)) + _lhs.getZ() * m_elements.at(static_cast<int>(c::c22)) + m_elements.at(static_cast<int>(c::c23));
	w = _lhs.getX() * m_elements.at(static_cast<int>(c::c30)) + _lhs.getY() * m_elements.at(static_cast<int>(c::c31)) + _lhs.getZ() * m_elements.at(static_cast<int>(c::c32)) + m_elements.at(static_cast<int>(c::c33));
